...
@Component({
  ...
  imports:[ CommonModule, FormsModule, ReactiveFormsModule, InputGroupModule, SliderModule, TooltipModule, ButtonModule, DateAgoPipe, HashSuffixPipe,InputTextModule, EditComponent],
  providers:[SystemService, LocalStorageService, ToastrService,HttpClient,FormBuilder],
  standalone: true
})
